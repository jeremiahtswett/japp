...
This is Milestone 1 of a larger pipeline (see `spec.md`): later milestones add
resume tailoring, assisted submission, and outcome tracking.
...
4. **Scaffold your config files:** `uv run japp init` — creates three files in the
   ...
   - `.env` — your API keys, each explained in the file:
     - `ANTHROPIC_API_KEY` — [console.anthropic.com](https://console.anthropic.com/) (scoring)
